...
function MechanismNode({ id, data, selected }: NodeProps<FlowNode>) {
    ...
    >
      ...
      <div className="p-3">
        <div className="flex items-center justify-between mb-1">
          <span className="text-[9px] font-bold text-slate-600 uppercase tracking-tighter">Mechanism</span>
          <button
            ...
            title="编辑节点"
          >
            <span className="material-symbols-outlined text-sm text-slate-400 hover:text-slate-500">more_horiz</span>
          </button>
        </div>
