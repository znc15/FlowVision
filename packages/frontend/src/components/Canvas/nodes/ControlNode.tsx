...
function ControlNode({ id, data, selected }: NodeProps<FlowNode>) {
    ...
    >
      ...
      <div className="p-3">
        <div className="flex items-center justify-between mb-1">
          <span className="text-[9px] font-bold text-amber-600 uppercase tracking-tighter">Control</span>
          <button
            ...
            title="编辑节点"
          >
            <span className="material-symbols-outlined text-sm text-slate-400 hover:text-amber-500">more_horiz</span>
          </button>
        </div>
