...
const MCP_TOOLS = [
  ...
  { name: 'get_diagram_info', desc: '获取当前图表类型和配置信息', icon: 'info', category: 'query' as const },
  { name: 'add_node', desc: '向流程图中添加新节点（支持 39 种类型）', icon: 'add_circle', category: 'mutate' as const },
  ...
  { name: 'clone_node', desc: '克隆指定节点', icon: 'content_copy', category: 'mutate' as const },
  { name: 'move_node', desc: '移动节点到指定位置', icon: 'open_with', category: 'mutate' as const },
  { name: 'connect_nodes', desc: '在两个节点之间创建连线', icon: 'link', category: 'mutate' as const },
  { name: 'batch_connect_nodes', desc: '批量创建多条连线', icon: 'hub', category: 'mutate' as const },
  ...
  { name: 'auto_layout', desc: '触发自动布局（dagre 算法）', icon: 'account_tree', category: 'manage' as const },
  { name: 'validate_graph', desc: '验证图表完整性（孤立边、悬挂节点）', icon: 'verified', category: 'manage' as const },
  { name: 'set_diagram_type', desc: '设置当前图表类型', icon: 'category', category: 'manage' as const },
];
